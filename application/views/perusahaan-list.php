  ...
  <div class="container filter-box">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-left" style="line-height:2;">
        ...
        <div class="checkbox">
          <label><input type="checkbox" />Lebih dari 3 ton / bulan</label><br>
          <label><input type="checkbox" />1 - 3 ton / bulan</label><br>
          <label><input type="checkbox" />0,5 - 1 ton / bulan</label><br>
          <label><input type="checkbox" />Kurang dari 0,5 ton / bulan</label><br>
        </div>
      </div>
      <div class="col-md-4 text-left" style="line-height:2;">
